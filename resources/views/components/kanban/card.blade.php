<a {{ $attributes->get('href') }} {{ $attributes->whereStartsWith('x-sort') }} class="block p-5 bg-white dark:bg-white/5 ring-1 ring-gray-950/10 dark:ring-white/20 rounded-md shadow">
